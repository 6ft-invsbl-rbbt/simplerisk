...
?>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="row-fluid">
            <h3>Open Risks (<? echo get_open_risks(); ?>)</h3>
          </div>
          <div class="row-fluid">
            <div class="span3">
              <div class="well">
                <? open_risk_status_pie(); ?>
              </div>
            </div>
            <div class="span3">
              <div class="well">
                <? open_risk_location_pie(); ?>
              </div>
            </div>
            <div class="span3">
              <div class="well">
                <? open_risk_category_pie(); ?>
              </div>
            </div>
          </div>
          <div class="row-fluid">
          ...
          <div class="row-fluid">
            <h3>Closed Risks: (<? echo get_closed_risks(); ?>)</h3>
          </div>
          <div class="row-fluid">
            <div class="span3">
              <div class="well">
                <? closed_risk_reason_pie(); ?>
              </div>
            </div>
          </div>
        </div>
