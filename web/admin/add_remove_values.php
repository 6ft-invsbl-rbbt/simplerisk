          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="hero-unit">
                ...
                Delete current category named <? create_dropdown("category"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_category" />
                </p>
                </form>
              </div>
              <div class="hero-unit">
                ...
                Delete current team named <? create_dropdown("team"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_team" />
                </p>
                </form>
              </div>
              <div class="hero-unit">
                ...
                Delete current technology named <? create_dropdown("technology"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_technology" />
                </p>
                </form>
              </div>
              <div class="hero-unit">
                ...
                Delete current site/location named <? create_dropdown("location"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_location" />
                </p>
                </form>
              </div>
              <div class="hero-unit">
                ...
                Delete current risk planning strategy named <? create_dropdown("planning_strategy"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_planning_strategy" />
                </p>
                </form>
              </div>
              <div class="hero-unit">
                ...
                Delete current close reason named <? create_dropdown("close_reason"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_close_reason" />
                </p>
                </form>
              </div>
            </div>
