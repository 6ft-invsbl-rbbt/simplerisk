        ...
        <div class="span9">
          <div class="row-fluid">
            <div class="span12">
              <div class="hero-unit">
                <h4>Custom Extras</h4>
                <p>It would be awesome if everything were free, right?  Hopefully the base SimpleRisk platform is able to serve all of your risk management needs.  But, if you find yourself still wanting more functionality, I'm working on a series of &quot;Extras&quot; that will do just that.  Things like:
                </p>
                <ul>
                  <li>Support for Active Directory Authentication.</li>
                  <li>Restriction of risk viewing to team members the risk is categorized as.</li>
                  <li>Email notifications when risks are updated.</li>
                  <li>Encryption of sensitive text fields in the database.</li>
                </ul>
