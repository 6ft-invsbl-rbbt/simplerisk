          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="hero-unit">
                ...
                <ul>
                  <li>The latest Application version is <? echo latest_version("app"); ?></li>
                  <li>You are running Application version <? echo current_version("app"); ?></li>
                </ul>
                </p>
                <p><h4>Database Version</h4>
                <ul>
                  <li>The latest Database version is <? echo latest_version("db"); ?></li>
                  <li>You are running Database version <? echo current_version("db"); ?></li>
                </ul>
                </p>
          ...
          <div class="row-fluid">
            ...
            <div class="span6">
              <div class="hero-unit">
                ...
                <input type="hidden" name="business" value="jsokol@austin.rr.com">
