<?
	...
	if (isset($_POST['update_order']))
	{
		...
		else $alert_message = "The project ID was not a valid v
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="hero-unit">
                ...
                Delete current project named <? create_dropdown("projects"); ?>&nbsp;&nbsp;<input type="submit" value="Delete" name="delete_project" />
                </p>
                </form>
              </div>
              <div class="hero-unit">
